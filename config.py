...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "7611315577:AAG6Xl0OBNsH1C0EzE5A45N4o09hKNoCBAs")
...
FORCESUB_CHANNEL2 = int(os.environ.get("FORCESUB_CHANNEL2", "-1002280632222"))

TG_BOT_WORKERS = int(os.environ.get("TG_BOT_WORKERS", "4"))

#pics
START_PIC = os.environ.get("START_PIC", "https://envs.sh/stU.jpg")
FORCE_PIC = os.environ.get("FORCE_PIC", "https://envs.sh/st4.jpg")
